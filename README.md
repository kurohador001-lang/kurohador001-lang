...
## 🧳 Моё портфолио:
1. [***Сайт - Future Tech***](https://github.com/kurohador001-lang/pet-project_future-tech)

## 🎓 Над чем сейчас работаю
На данный момент я занимаюсь изучением React и разработкой пет-проекта с его использованием
